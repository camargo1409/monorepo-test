...
const LinkItems: Array<LinkItemProps> = [
  { name: 'Mapa', icon: RiMapPin5Line, url: '/map' },
  { name: 'Dashboard', icon: MdOutlineDashboard, url: '/dashboard' },
  { name: 'Configurações', icon: BsGear, url: '/profile' },
];
        ...
        <Flex alignItems={'center'}>
          <Menu>
              ...
              <HStack>
                ...
                <VStack
                  ...
                  <Text fontSize="xs" color="gray.600">
                    {user.available ? 'Provedor' : 'Cliente'}
                  </Text>
                </VStack>
            ...
            <MenuList
              ...
              zIndex='2'
              >
              <Link href="/profile"><MenuItem>Meu perfil</MenuItem></Link>
              <Link href="/profile"><MenuItem>Configurações</MenuItem></Link>
              <MenuDivider />
